...
func Skip[CT comparable, T any](skipParser Parser[CT, any], parser Parser[CT, T]) Parser[CT, T] {
...
// while parsing with parser.
func Unskip[CT comparable, T any](skipParser Parser[CT, any], parser Parser[CT, T]) Parser[CT, T] {
	return func(ctx Context[CT]) (T, error) {
