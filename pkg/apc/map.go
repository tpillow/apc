...
func Map[CT comparable, T, U any](parser Parser[CT, T], mapFunc MapFunc[T, U]) Parser[CT, U] {
...
func Bind[CT comparable, T, U any](parser Parser[CT, T], node U) Parser[CT, U] {
...
func MapCast[CT comparable, T, U any](parser Parser[CT, T]) Parser[CT, U] {
...
func MapToAny[CT comparable, T any](parser Parser[CT, T]) Parser[CT, any] {
